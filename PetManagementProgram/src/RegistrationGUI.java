...
public class RegistrationGUI {
	...
	private void initialize() {
		...
		lblId.setFont(new Font("맑은 고딕", Font.PLAIN, 18));
		...
		managerButton.setFont(new Font("맑은 고딕", Font.PLAIN, 16));
		...
		memberButton.setFont(new Font("맑은 고딕", Font.PLAIN, 16));
		...
		btnNewButton.setFont(new Font("맑은 고딕", Font.PLAIN, 21));
